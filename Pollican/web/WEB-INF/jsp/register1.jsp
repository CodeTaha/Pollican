   ...
   <form name="f2" method="post" action="register2" id="f2">
    <div id="signUpForm" class="form-horizontal">
        <div class="form-group">
            <label class="control-label col-sm-2" for="dp">Profile Pic :</label>
            <div class="col-sm-3">
                <img name="dp" id="dp" src=${param.response_dp} >
                <input type="hidden" name="dpsend" id="dpsend" value="${param.response_dp}">
            </div>
        </div>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-5">
                 <button type='submit' class='btn btn-sm btn-primary pull-right' id="next">NEXT</button>
                <!--<input type="submit" value="NEXT"  style="font-size:18px; " />-->
            </div>
        ...
        <div class="form-group" style="visibility:hidden">
            ...
            <div class="well col-sm-6">  
             <input type="hidden" name="response_red_url" value="${param.response_red_url}" readonly> 
